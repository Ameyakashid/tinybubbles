...
import { createTinyBubblesAutomationStorage } from './tinybubbles-automation-storage';
...
export async function createTinyBubblesAutomationService(options: AutomationServiceOptions = {}) {
    const storage = createTinyBubblesAutomationStorage(options);
