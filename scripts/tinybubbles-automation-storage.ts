...
import { resolveTinyBubblesStoragePaths } from './tinybubbles-paths';
...
export function createTinyBubblesAutomationStorage(options: AutomationStorageOptions = {}): AutomationStorage {
    const paths = resolveTinyBubblesStoragePaths(options);
