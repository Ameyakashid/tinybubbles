package app.tinybubbles.notificationopenintents
...
object PersistentCaptureNotifier {
  const val CHANNEL_ID = "tinybubbles-persistent-capture"
  ...
  private const val CAPTURE_URI = "tinybubbles:///capture-quick?mode=text"
  private const val CONTENT_REQUEST_CODE = NOTIFICATION_ID
  private const val DISMISS_REQUEST_CODE = NOTIFICATION_ID + 1

  const val EXTRA_TITLE = "app.tinybubbles.persistentCapture.title"
  const val EXTRA_TEXT = "app.tinybubbles.persistentCapture.text"
  const val EXTRA_CHANNEL_NAME = "app.tinybubbles.persistentCapture.channelName"
  ...
  // dismiss intent (#819).
  private const val PREFS_NAME = "tinybubbles-persistent-capture"
