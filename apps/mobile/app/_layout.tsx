...
const UPDATE_REMINDER_RELEASES_API = 'https://api.github.com/repos/Ameyakashid/tinybubbles/releases/latest';
const UPDATE_REMINDER_RELEASES_URL = 'https://github.com/Ameyakashid/tinybubbles/releases/latest';
