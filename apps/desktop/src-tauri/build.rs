fn main() {
    #[cfg(target_os = "macos")]
    {
        cc::Build::new()
            ...
            .flag("-fobjc-arc")
            .compile("tinybubbles_macos_eventkit_bridge");
        cc::Build::new()
            .file("src/macos_sandbox_bridge.m")
            .flag("-fobjc-arc")
            .compile("tinybubbles_macos_sandbox_bridge");
        cc::Build::new()
            .file("src/macos_cloudkit_bridge.m")
            .flag("-fobjc-arc")
            .compile("tinybubbles_macos_cloudkit_bridge");
        cc::Build::new()
            .file("src/macos_quick_add_focus_bridge.m")
            .flag("-fobjc-arc")
            .compile("tinybubbles_macos_quick_add_focus_bridge");
