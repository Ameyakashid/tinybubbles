...
const EN_OVERRIDES: Record<string, string> = {
    ...
    'kidface.today.header.emptyScheduled.one': 'Nothing today — 1 thing coming up',
    'kidface.today.header.emptyScheduled.other': 'Nothing today — {count} things coming up',
    ...
    'kidface.today.scheduledEmpty.title': 'Free today',
    ...
    'kidface.done.title': 'Done',
    'kidface.done.heading': 'Trophy case',
    'kidface.done.subtitle': 'Things you finished',
    'kidface.done.empty.title': 'No trophies yet',
    'kidface.done.empty.hint': 'Finish something and it will show up here.',
    'kidface.done.group.today': 'Today',
    'kidface.done.group.yesterday': 'Yesterday',
    'kidface.done.group.earlier': 'Before that',
    'kidface.done.summary.today.one': '1 trophy today',
    'kidface.done.summary.today.other': '{count} trophies today',
    'kidface.done.summary.total.one': '1 trophy total',
    ...
    'calmCorner.feelingWorried': 'Worried',
    'calmCorner.feelingTired': 'Tired',
    'calmCorner.feelingUnknown': "I don't know",
    'calmCorner.breatheIn': 'Breathe in',
    'calmCorner.breatheOut': 'Breathe out',
    'calmCorner.breatheWithMe': 'Breathe with the bubble.',
    'calmCorner.ready': "I'm ready",
    // Gentle streaks and milestones — breadth, not chains.
    'kidface.celebration.firstCompletion': 'You finished your first thing!',
    'kidface.celebration.manyCompletions': 'You finished {count} things today!',
    'kidface.celebration.varietyOfDays': 'You have finished things on {count} different days.',
    'kidface.celebration.gentleStreak': 'You have finished things {count} days in a row.',
    'kidface.celebration.longestRun': 'Your longest run is {count} days.',
    ...
    'kidface.settings.languageConfirm.title': 'Switch language?',
    'kidface.settings.languageConfirm.message': 'This will change the words in the app to {target}.',
    'kidface.settings.languageConfirm.keep': 'Keep {current}',
    'kidface.settings.languageConfirm.switch': 'Switch to {target}',
