...
const PRE_REFACTOR_TASK_SQLITE_COLUMNS = [
    ...
    'focusOrder', 'isFocusedToday', 'timeEstimate', 'timeSpentMinutes', 'suppressTinyBubblesReminders',
...
suppressTinyBubblesReminders=excluded.suppressTinyBubblesReminders,
...
const PRE_REFACTOR_ENSURE_TASK_COLUMNS_NAMES = [
    ...
    'timeSpentMinutes', 'suppressTinyBubblesReminders', 'reviewAt', 'completedAt',
...
const PRE_REFACTOR_ENSURE_TASK_COLUMNS_SQL = [
    ...
    'ALTER TABLE tasks ADD COLUMN suppressTinyBubblesReminders INTEGER',
