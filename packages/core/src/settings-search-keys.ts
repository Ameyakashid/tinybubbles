...
export const SETTINGS_SEARCH_PAGE_KEYS: Record<SettingsSearchPageId, readonly SettingsSearchEntry[]> = {
    ...
    manage: ['manage', 'manageAreas', 'manageContexts', 'manageTags'],
    notifications: [
        'notifications',
        'notificationsEnable',
    ...
    data: [
        'dataTransfer',
        { key: 'exportBackup', section: 'dataTransfer' },
        { key: 'restoreBackup', section: 'dataTransfer' },
        { key: 'mergeBackup', section: 'dataTransfer' },
        { key: 'importTodoist', section: 'dataTransfer' },
        { key: 'importTickTick', section: 'dataTransfer' },
        { key: 'importDgt', section: 'dataTransfer' },
        { key: 'importOmniFocus', section: 'dataTransfer' },
        'attachmentsCleanup',
        'diagnostics',
