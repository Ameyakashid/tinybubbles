...
- Mobile Calendar keeps long task titles clear of the **Schedule** action, shows the selected date in planning labels, and places task search before planning suggestions. (#972)
